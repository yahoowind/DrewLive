...
CHANNEL_MAPPINGS = {
    ...
    "VE-2uk-tntsport5 (sv3-CDN)": {"name": "TNT Sport 5 UK", "tv-id": "TNT.Sports.HD.Final.uk"},
    ...
    "VE-usa-uni34": {"name": "UniMás 34", "tv-id": "UniMÃ¡s.(KMEX-DT2).Los.Angeles,.CA.us", "logo": "https://github.com/tv-logo/tv-logos/blob/main/countries/united-states/unimas-us.png?raw=true"},
    ...
    "VE-usa-unimas": {"name": "UniMás", "tv-id": "UniMÃ¡s.(KMEX-DT2).Los.Angeles,.CA.us", "logo": "https://github.com/tv-logo/tv-logos/blob/main/countries/united-states/unimas-us.png?raw=true"},
