...
CHANNEL_MAPPINGS = {
    ...
    "VE-1cdn - uk-skysportaction": {"name": "Sky Sport Action UK", "tv-id": "SkySp.ActionHD.uk"},
    ...
    "VE-3uk-premiersport2 (cdn)": {"name": "Premier Sport 2 UK", "tv-id": "Premier.Sports.2.HD.uk"},
    ...
    "VE-cdn - us-wnetwork": {"name": "W Network", "tv-id": "W.Network.Canada.East.(WTN).ca"},
    ...
    "VE-us-fightnetwork": {"name": "The Fight Network", "tv-id": "The.Fight.Network.(United.States).(TFN).us"},
