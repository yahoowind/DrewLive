...
CHANNEL_MAPPING = {
    ...
    "ori2usanbcnewyork": {"name": "ABCNY", "tv_id": "ABC.(WABC).New.York,.NY.us", "logo": "https://github.com/tv-logo/tv-logos/blob/main/countries/united-states/abc-logo-2013-default-us.png?raw=true", "group": "USA"},
    ...
    "ori2uksv2skysportplus": {"name": "Sky Sport Plus UK", "tv_id": "SkySp.PL.HD.uk", "group": "UK Sports"},
    ...
    "ori2cdnusaccnetwork": {"name": "UniMás", "tv_id": "UniMas.(KFTH).Houston,.TX.us", "logo": "https://github.com/tv-logo/tv-logos/blob/main/countries/united-states/unimas-us.png?raw=true", "group": "USA"},
